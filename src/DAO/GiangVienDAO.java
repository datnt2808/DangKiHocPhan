...
public class GiangVienDAO extends AbstractTableModel {
    ...
    public String Name[] = {"Mã Giảng Viên", "Tên Giảng Viên", "Ðia Chi", "Bac luong", "Que Quan"};
    public Class classess[] = {String.class, String.class,String.class,String.class,String.class};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 3:
                return ds.get(rowIndex).getBacLuong();
            case 4:
                return ds.get(rowIndex).getQueQuan();
            default:
                return null;
        }
    }
